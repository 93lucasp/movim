...
gulp.task('default', gulpSequence('sass', 'css', 'js-vendors', 'html', 'js', 'copy-images', 'serve', ));
gulp.task('public', gulpSequence('sass', 'css', 'js-vendors', 'html', 'js-compress', 'copy-images', 'serve', ));